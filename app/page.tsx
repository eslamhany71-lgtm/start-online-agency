...
export default function Home() {
  ...
  // المصفوفة دي عشان تقدر تعدل مشاريع الاستوديو بسهولة وتزود روابطها
  const studioProjects = [
    { title: "Reels & Short Films", desc: "Scroll-stopping content for social.", link: "/services" },
    { title: "Podcasts", desc: "Thought leadership conversations.", link: "/services" },
    { title: "Commercial Production", desc: "High-quality commercials.", link: "/services" },
    { title: "AI Production", desc: "AI avatars and automated video.", link: "/services" }
  ];
  ...
  return (
    <main className="min-h-screen bg-[#FCFBFA] text-[#111111] flex flex-col items-center justify-start overflow-hidden pt-20">
      ...
      <section className="w-full max-w-[1280px] mx-auto px-6 md:px-8 lg:px-20 min-h-[680px] flex flex-col lg:flex-row items-center justify-between gap-6 py-20 lg:py-24">
        ...
        <div className="w-full lg:w-[48%] relative flex justify-center items-center mt-16 lg:mt-0 min-h-[500px]">
          ...
          <div className="absolute top-[10%] left-[5%] bg-white px-4 py-3 rounded-[16px] shadow-sm border border-[rgba(17,17,17,0.04)] flex items-center gap-2 animate-[bounce_4s_infinite]">
            <span className="w-2 h-2 rounded-full bg-[#E01E2E]"></span><span className="text-[12px] font-bold text-[#111111]">Technology</span>
          </div>
          <div className="absolute top-[20%] right-[0%] bg-white px-4 py-3 rounded-[16px] shadow-sm border border-[rgba(17,17,17,0.04)] flex items-center gap-2 animate-[bounce_5s_infinite]">
            <span className="w-2 h-2 rounded-full bg-[#E01E2E]"></span><span className="text-[12px] font-bold text-[#111111]">Marketing</span>
          </div>
          <div className="absolute bottom-[20%] left-[0%] bg-white px-4 py-3 rounded-[16px] shadow-sm border border-[rgba(17,17,17,0.04)] flex items-center gap-2 animate-[bounce_4.5s_infinite]">
            <span className="w-2 h-2 rounded-full bg-[#E01E2E]"></span><span className="text-[12px] font-bold text-[#111111]">Content</span>
          </div>
          <div className="absolute bottom-[10%] right-[5%] bg-white px-4 py-3 rounded-[16px] shadow-sm border border-[rgba(17,17,17,0.04)] flex items-center gap-2 animate-[bounce_5.5s_infinite]">
            <span className="w-2 h-2 rounded-full bg-[#E01E2E]"></span><span className="text-[12px] font-bold text-[#111111]">Growth</span>
          </div>
        </div>
      </section>
      ...
      {/* SECTION - SOA STUDIO (Dynamic Array & Clickable) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[24px]">
            {studioProjects.map((item, i) => (
              <Link 
                href={item.link} 
                key={i} 
                className="group relative aspect-[4/3] rounded-[20px] overflow-hidden bg-[#1A1A1A] cursor-pointer block border border-white/5"
              >
